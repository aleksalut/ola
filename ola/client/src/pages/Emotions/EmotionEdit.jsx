...
export default function EmotionEdit(){
  ...
  useEffect(()=>{ 
    getById(id).then(e=>{ 
      setText(e.text || e.note || '')
      setAnxiety(e.anxiety?.toString() || '')
      setCalmness(e.calmness?.toString() || '')
      setJoy(e.joy?.toString() || '')
      setAnger(e.anger?.toString() || '')
      setBoredom(e.boredom?.toString() || '')
      setLoading(false) 
